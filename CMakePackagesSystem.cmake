...
macro(_add_package_dependencies PKG DEP _dep_name)
  ...
  if(${_opt_name})
    package_nature(${DEP} _nature)
    string(TOUPPER ${DEP} _dep)
    if (${_nature} STREQUAL "external")
      add_external_package(${_dep} ${_var_dep_desc})
    endif()
    if (${_nature} STREQUAL "external_optional")
      package_opt_name (${_dep} _dep_option_name)
      set(${_dep_option_name} ON)
      add_optional_external_package(${_dep} ${_var_dep_desc} ON)
    endif()
