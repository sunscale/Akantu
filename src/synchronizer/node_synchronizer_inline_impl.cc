/**
 * @file   node_synchronizer_inline_impl.cc
 *
...
#ifndef __AKANTU_NODE_SYNCHRONIZER_INLINE_IMPL_CC__
#define __AKANTU_NODE_SYNCHRONIZER_INLINE_IMPL_CC__
...
#endif // __AKANTU_NODE_SYNCHRONIZER_INLINE_IMPL_CC__
